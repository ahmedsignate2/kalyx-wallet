 ...
 *
 * - PLAY_STORE_URL : lien universel — ouvre le Play Store ; si Nova est déjà
 ...
 * un domaine hébergeant un fichier assetlinks.json — à faire quand nova.wallet
 * sera en ligne. En attendant, le lien Play Store est la solution honnête.
 */
export const ANDROID_PACKAGE = 'com.nova.wallet';
export const PLAY_STORE_URL = `https://play.google.com/store/apps/details?id=${ANDROID_PACKAGE}`;
export const APP_SCHEME = 'novawallet';

/** URL intent:// : ouvre Nova (scheme) si installée, sinon fallback Play Store. */
