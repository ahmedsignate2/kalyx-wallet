...
export function Navbar() {
  ...
  return (
    <nav className="fixed inset-x-0 top-0 z-50 bg-[#06070D]/75 backdrop-blur-xl">
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-5 sm:px-8 lg:px-10">
        <Link href="/" className="flex items-center gap-2.5 text-white">
          <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-[#F4F6FF] text-sm font-black text-[#06070D]">K</span>
        ...
        <div className="hidden items-center gap-5 md:flex">
          ...
          <a href="#download" className="inline-flex items-center gap-2 rounded-full bg-[#F4F6FF] px-5 py-2.5 text-sm font-bold text-[#06070D] transition hover:bg-white">
      ...
      {open && (
        <div className="space-y-3 bg-[#06070D] px-5 pb-6 md:hidden">
          ...
          <a href="#download" onClick={() => setOpen(false)} className="flex items-center justify-center gap-2 rounded-full bg-[#F4F6FF] px-5 py-3 text-sm font-bold text-[#06070D]">
            <Download className="h-4 w-4" /> Télécharger Kalyx
          </a>
        </div>
      )}
