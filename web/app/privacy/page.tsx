...
export const metadata = {
  ...
  description:
    'Politique de confidentialité et protection des données personnelles de Kalyx Wallet, portefeuille non-custodial.',
};
...
• Hébergement de l'application : Application mobile non-custodial exécutée localement sur l'appareil de l'utilisateur, ne nécessitant aucun serveur central de stockage de clés ou de base de données d'utilisateurs.`,
  ...
  return (
    <LegalPage
      ...
      intro="Chez Kalyx, ta vie privée n’est pas une option : c’est le fondement de l’architecture. Voici comment nous protégeons tes données, en refusant de les collecter."
      meta={['Dernière mise à jour : 5 juillet 2026', 'Kalyx (Ahamed Signate)', 'Droit français et RGPD']}
      sections={sections}
      contactTitle="Une question sur tes données ?"
      contactText="Écris-nous pour toute demande relative à la sécurité ou à la conformité."
    />
  );
}
