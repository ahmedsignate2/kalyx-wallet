...
export const metadata = {
  ...
  description:
    "Conditions générales d'utilisation régissant l'usage de l'application mobile et des services Kalyx Wallet.",
};
...
Canal officiel Telegram : https://t.me/kalyxntw`,
  ...
  return (
    <LegalPage
      ...
      intro="Lis attentivement ces conditions avant d’utiliser Kalyx Wallet. Elles définissent le cadre d’utilisation responsable et les spécificités du modèle non-custodial."
      meta={['Dernière révision : 5 juillet 2026', 'Version bêta', 'Modèle non-custodial']}
      sections={sections}
      contactTitle="Besoin d’éclaircissements ?"
      contactText="Écris-nous pour toute question relative aux conditions, juridique ou technique."
    />
  );
}
